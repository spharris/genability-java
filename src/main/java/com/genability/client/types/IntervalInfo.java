...
public class IntervalInfo {
  ...
  /**
   * Helper method that will populate the measures map with the measure passed in. If you pass in a
   * kWh, kW or total measure, it will set those specific fields instead.
   * 
   * @param key The key.
  ...
  public void putMeasure(String key, Measure value) {
    ...
    if (ReadingData.KWH_UNIT.equals(key)) {
      ...
      if (this.measures == null) this.measures = new LinkedHashMap<String, Measure>();
  ...
  /**
   * Helper method that will return the measures that matches the key, including if the key is
   * 'kWh", "kW" or "total". If not found it will return null.
   * 
   * @param key The key.
