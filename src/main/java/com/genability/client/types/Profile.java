...
public class Profile implements Serializable {
  ...
  /**
   * Pass in a quantityUnit value and this will tell you whether there is 1 or more readings for it.
   * 
  ...
  public boolean hasReadingsFor(String quantityUnit) {
    ...
    for (ReadingDataSummary summary : this.getReadingDataSummaries()) {
      if (quantityUnit.equals(summary.getQuantityUnit()) && summary.getNumberOfReadings() != null
  ...
  /**
   * Helper method to make a copy of the profile. Note it doesn't make a copy of the readings,
   * reading summaries, or properties
   * 
   * @param toCopyToProfile The toCopyToProfile. to copy data into
   */
