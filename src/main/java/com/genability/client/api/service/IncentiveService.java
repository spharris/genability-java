...
public class IncentiveService extends BaseService {
  ...
  public Response<Incentive> getIncentives(GetIncentivesRequest request) {
    ...
    Response<Incentive> response =
        this.callGet(baseUrl, request.getQueryParams(), INCENTIVE_RESPONSE_TYPEREF);
  ...
  public Response<Incentive> getIncentive(long masterIncentiveId) {
    ...
    Response<Incentive> response = this.callGet(url, null, INCENTIVE_RESPONSE_TYPEREF);
  ...
  public Response<IncentiveApplicability> getIncentiveApplicabilities(
    ...
    Response<IncentiveApplicability> response =
        this.callGet(url, request.getQueryParams(), INCENTIVE_APPLICABILITY_RESPONSE_TYPEREF);
