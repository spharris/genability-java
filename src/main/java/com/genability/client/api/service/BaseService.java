...
public class BaseService {
  ...
  /**
   * Mutator for IoC and configuration. If not called, this property defaults to the Genability
  ...
  /**
   * Mutator for IoC and configuration. Typically you don't need to worry about this as the default
   * sets up a mapper for you.
   * 
   ...
   */
  protected <T extends Response<R>, R> T callGet(String endpointPath,
      List<NameValuePair> queryParams,
      TypeReference<T> resultTypeReference) {
    String qs = null;

    String url = restApiServer + endpointPath; // + "?" + this.getQueryStringCredentials(); // if
                                               // you prefer to pass creds on query string
   ...
   * @return The return value.
   */
  protected <T extends Response<R>, R> T callPost(String endpointPath,
  ...
  /**
   * This method is used to upload large datasets, typically CSV or XML files. The request object
   * passed in contains the File to upload.
   * 
   * @param <T> The type parameter.
   * @param <R> The type parameter.
   * @param endpointPath The endpointPath.
   ...
   * @return The return value.
   */
  public <T extends Response<R>, R> T callFileUpload(String endpointPath,
   ...
   * @return The return value.
   */
  protected <T extends Response<R>, R> T callDelete(String endpointPath,
      List<NameValuePair> queryParams,
      TypeReference<T> resultTypeReference) {
    String qs = null;
  ...
  protected <T extends Response<R>, R> T execute(HttpRequestBase request,
