...
/*
 * This test double intercepts the HttpRequests sent by a service and checks to make sure that the
 * specified URI matches the expected URI
 */
public class MockHttpClient implements HttpClient {
  ...
  public void validate() {
    ...
    if (splitUri.length > 1) {
      ...
      assertEquals("Parameter lists didn't have the same length", expectedParameters.size(),
          paramList.size());
