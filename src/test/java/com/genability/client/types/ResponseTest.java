...
public class ResponseTest {
  ...
  @Test
  public void formatsAutoValueClassName() {
    Response<Account> result = Response.of(Account.builder().build());
    
    assertThat(result.getType()).isEqualTo("Account");
  }
  
  @Test
  public void formatsInnerAutoValueClassName() {
    Response<TestClass> result = Response.of(TestClass.create());
    
    assertThat(result.getType()).isEqualTo("TestClass");
  }
  
  @AutoValue
  abstract static class TestClass {
    static TestClass create() {
      return new AutoValue_ResponseTest_TestClass();
    }
  }
}
