...
public class IncentiveServiceTests extends BaseServiceTests {
  ...
  public void testGetIncentiveApplicabilities() {
    ...
    Response<IncentiveApplicability> response =
        incentiveService.getIncentiveApplicabilities(request);
  ...
  public void testGetIncentives() {
    ...
    for (Incentive result : results) {
      ...
      if (result.getEndDate() != null) {
        assertTrue("Only incentives that haven't ended should be returned",
            result.getEndDate().isAfter(effectiveOn));
      }
